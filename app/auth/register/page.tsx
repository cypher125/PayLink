...
export default function RegisterPage() {
  ...
  // Update the updateFormData function to validate password when it changes
  ...
  const handleSubmit = async () => {
    ...
    // Prepare the register data from form data
    const registerData = {
      ...
      bvn: formData.bvn,
      preferred_network: formData.preferredNetwork
    }
    ...
    try {
      ...
      if (result?.success) {
        ...
        setTimeout(() => {
          toast.success("Registration successful! Please set up your PIN.")
        ...
        return (
          ...
          >
            {/* Existing Step 1 fields */}
              ...
              {/* Password - Updated with validation */}
              <div>
